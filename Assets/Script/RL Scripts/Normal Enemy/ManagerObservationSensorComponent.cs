...
/// This component creates the ManagerObservationSensor (plain C# ISensor, not MonoBehaviour, 16-dim global observations)
/// and passes it the required references.
///
/// Usage:
///   1. Add this component to the agent GameObject (alongside BehaviorParameters)
///   2. It will automatically register as an additional observation sensor (16-dim features for manager critic)
...
public class ManagerObservationSensorComponent : SensorComponent
{
    ...
    public float ArenaHalfSizeX => arenaHalfSizeX;
    public float ArenaHalfSizeZ => arenaHalfSizeZ;
